      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 gap-4 sm:grid-cols-4 max-w-6xl mx-auto">
          {facilities.map((f, index) => (
            ...
            >
              <span className="text-3xl mb-2.5 filter drop-shadow-sm">{f.icon}</span>
              <span className="text-sm font-extrabold text-[#1344e6] font-display">{f.name}</span>
            </div>
          ))}
        </div>
        ...
        <div className="mt-16 max-w-6xl mx-auto">
          <div className="rounded-3xl bg-gradient-to-r from-blue-600 to-[#1344e6] px-8 py-10 text-white shadow-xl relative overflow-hidden">
            <div className="absolute right-0 top-0 h-40 w-40 bg-white/5 blur-3xl rounded-full"></div>
            
            <h3 className="font-display text-2xl font-extrabold tracking-tight mb-5">
              Modern Infrastructure
            </h3>
            
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 text-sm leading-relaxed text-blue-100">
        ...
        <div className="mt-10 grid grid-cols-1 gap-6 md:grid-cols-12 max-w-6xl mx-auto">
          ...
          <div className="md:col-span-8 aspect-[16/10] rounded-3xl bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-100/50 flex flex-col items-center justify-center p-6 text-center shadow-sm">
            <span className="text-sm font-semibold tracking-wider text-slate-500 font-display uppercase">
              Main Campus View
            </span>
          </div>
